			...
			<div className="max-w-6xl mx-auto relative z-10">
				...
				>
					...
					<p className="text-muted-foreground max-w-xl mx-auto text-lg font-light tracking-wide">
						Top up your balance to continue generating studio-grade headshots.
						Simple, transparent pricing with no hidden subscriptions.
					</p>
				</motion.div>
							...
							<div className="space-y-6">
								...
								<ul className="space-y-4">
									{plan.features.map((feature) => (
										<li
											key={feature}
											className="flex gap-3 text-sm text-white/80 font-light"
										>
											<CheckCircle2
												className={cn(
													"w-4 h-4 shrink-0 mt-0.5",
													plan.isPopular ? "text-primary" : "text-white/40",
												)}
											/>
											<span>{feature}</span>
										</li>
