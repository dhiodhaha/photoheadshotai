			...
			<div className="flex items-center justify-center p-8 bg-background relative z-10">
				...
				>
					<div className="space-y-4">
						<h1 className="text-4xl font-display tracking-tight">Sign in to Studio</h1>
						...
						<div className="space-y-6">
							...
							<div className="space-y-2">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Link to="/" className="text-[10px] uppercase tracking-widest text-primary hover:underline underline-offset-4">Forgot Password?</Link>
                                </div>
								<Input 
									id="password" 
									type="password" 
					...
					<div className="pt-8 border-t border-white/5 text-center">
						<p className="text-sm text-muted-foreground">
							Not a member yet?{' '}
							<Link to="/auth/signup" className="text-primary hover:underline underline-offset-4 font-medium">
								Create Account
							</Link>
						</p>
					</div>
